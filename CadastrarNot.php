...
<head>
    ...
    <link rel="stylesheet" href="./css/cadastrarNot.css" type="text/css">
</head>
<body>
   <header>
   ...
   <div class="row">
    <form class="card">
        ...
        <label for="inputnome">Título da Notícia</label>
        <input type="text" id="inputnome" >
       
        <label for="inputnome">Cadastrar Notícias</label>
        <input type="text" id="inputnome" >
   

        <button><a href="./Notícias.html" class="bnt">Cadastrar Notícia</a></button>
    </form>
   </div>
